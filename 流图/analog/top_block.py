...
# Title: Top Block
# Generated: Wed Jan 24 13:04:19 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, 1000, 12, 0)
        ...
        self.connect((self.analog_wfm_rcv_0, 0), (self.blocks_multiply_xx_0_1, 1))    
        ...
        self.connect((self.blocks_multiply_xx_0_1, 0), (self.blocks_float_to_int_0, 0))    
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.qtgui_time_sink_x_1_0, 0))    
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.qtgui_time_sink_x_2, 0))    
